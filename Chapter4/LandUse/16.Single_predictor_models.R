...
ModelData <- readRDS("../Data/Data_for_class_specific_models.rds")
...
saveRDS(Amphibians1, "../Results/Single_predictor_models/Amphibians_specialisation.rds")
saveRDS(Amphibians2, "../Results/Single_predictor_models/Amphibians_diel_activity.rds")
saveRDS(Amphibians3, "../Results/Single_predictor_models/Amphibians_diet.rds")
...
saveRDS(Reptiles1, "../Results/Single_predictor_models/Reptiles_specialisation.rds")
saveRDS(Reptiles2, "../Results/Single_predictor_models/Reptiles_diel_activity.rds")
saveRDS(Reptiles3, "../Results/Single_predictor_models/Reptiles_diet.rds")
...
saveRDS(Mammals1, "../Results/Single_predictor_models/Mammals_specialisation.rds")
saveRDS(Mammals2, "../Results/Single_predictor_models/Mammals_diel_activity.rds")
saveRDS(Mammals3, "../Results/Single_predictor_models/Mammals_diet.rds")
...
saveRDS(Birds1, "../Results/Single_predictor_models/Birds_specialisation.rds")
saveRDS(Birds2, "../Results/Single_predictor_models/Birds_diel_activity.rds")
saveRDS(Birds3, "../Results/Single_predictor_models/Birds_diet.rds")
...
Run_on_all <- function(Class) {
  ...
  for(t in Traits){
    ...
    Path <- paste0("../Results/Single_predictor_models/", Class, "_", t, ".rds")
    saveRDS(Model, Path)
  }
}
