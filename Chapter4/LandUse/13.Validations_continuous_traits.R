...
SlopesAmphibians <- Run_on_traits(Model = Amphibians, PD = FALSE, Traits = Cont_traits_amphi, Class="Amphibians")

## SLOPES for reptiles
SlopesReptiles <- Run_on_traits(Model = Reptiles, PD = FALSE, Traits = Cont_traits_reptiles, Class="Reptiles")
...
Slopes$Median[Slopes$Trait=="log10_Range_area" & Slopes$Class=="Amphibians" & Slopes$LandUseGrouped=="Urban"] <- NA
Slopes$Lower[Slopes$Trait=="log10_Range_area" & Slopes$Class=="Amphibians" & Slopes$LandUseGrouped=="Urban"] <- NA
Slopes$Upper[Slopes$Trait=="log10_Range_area" & Slopes$Class=="Amphibians" & Slopes$LandUseGrouped=="Urban"] <- NA

p <- Plot_slopes_fun_Allfacet(Slopes[Slopes$Trait=="log10_Lifespan_proxy"])
p
