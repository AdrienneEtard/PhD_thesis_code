...
Get_effects_cat <- function(Model, Trait, Class) {
  ...
  if(Class=="Reptiles"|(Class=="Amphibians"&Trait=="Natural habitat specialist")|((Trait=="VE"|Trait=="PL|SE") & Class=="Mammals")){
...
## loading models
Birds <- readRDS("../Results/Validations/Birds_Diet.rds")
Mammals <- readRDS("../Results/Validations/Mammals_Diet.rds")
Amphibians <- readRDS("../Results/Validations/Amphibians_Diet.rds") ## no primary , no bm, lcs, lp
Reptiles <- readRDS("../Results/Validations/Reptiles_Diet.rds")## no primary diet, bm
...
ggsave(Plot, filename="E:/Habitat_vars_predict_vertebrate_sensitivity_better_than_lht/Habitat_vars_predict_vertebrate_sensitivity_better_than_lht/Figures/Land_use_categorical_traits_validation.pdf",
       width=12, height = 11)
