...
Spe_A <- readRDS( "../Results/Single_predictor_models/Validations/Amphibians_specialisation.rds")
Spe_B <- readRDS( "../Results/Single_predictor_models/Validations/Birds_specialisation.rds")
Spe_M <- readRDS( "../Results/Single_predictor_models/Validations/Mammals_specialisation.rds")
Spe_R <- readRDS( "../Results/Single_predictor_models/Validations/Reptiles_specialisation.rds")
...
#ggsave(Plot_Spe, filename="../Results/Single_predictor_models/Figures/Specialisation.pdf", width = 10, height=7)

##########################################################################################################################################
##### PREDICTING FOR DIEL ACTIVITY
DA_A <- readRDS( "../Results/Single_predictor_models/Validations/Amphibians_diel_activity.rds")
DA_B <- readRDS( "../Results/Single_predictor_models/Validations/Birds_diel_activity.rds")
DA_M <- readRDS( "../Results/Single_predictor_models/Validations/Mammals_diel_activity.rds")
DA_R <- readRDS( "../Results/Single_predictor_models/Validations/Reptiles_diel_activity.rds")
...
ggsave(Plot_DA, filename="../Results/Single_predictor_models/Figures/Diel_activity.pdf", width = 10, height=7)


##########################################################################################################################################
##### PREDICTING FOR PRIMARY DIET
Diet_B <- readRDS( "../Results/Single_predictor_models/Validations/Birds_diet.rds")
Diet_M <- readRDS( "../Results/Single_predictor_models/Validations/Mammals_diet.rds")

Diet_A <- readRDS("../Results/Single_predictor_models/Validations/Amphibians_diet.rds")
Diet_R <- readRDS("../Results/Single_predictor_models/Validations/Reptiles_diet.rds")

Diet_A@frame$Primary_diet %>%  unique()
...
ggsave(P_diet, filename="G:/Habitat_vars_predict_vertebrate_sensitivity_better_than_lht/Habitat_vars_predict_vertebrate_sensitivity_better_than_lht/Supporting Information/Figures/Partial_models_predictions/Validations/Diet.pdf", width = 11, height=10)
